...
// figma node: 7476:54760 Components (2 variants)
...
export function Components3(_p = {}) {
  ...
  const __body0 = () => (
    <div className={props.className} style={{
      ...
      <span style={{
        ...
        flexShrink: 0,
        alignSelf: "stretch",
      }}>{props.text1 ?? "Expired Auth(s)"}</span>
      <div style={{
          position: "relative",
          width: 20,
          height: 22,
    ...
    <div className={props.className} style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          }}>{props.text2 ?? "Number of Approved auth expired"}</span>
          <div style={{
            position: "absolute",
            left: 0,
            top: 0,
